...
register(
    id="HopperResample-v4",
    entry_point="gymnasium.envs.mujoco.hopper_v4-s:HopperEnv",
    max_episode_steps=1000,
)

register(
    id="Walker2dResample-v4",
    entry_point="gymnasium.envs.mujoco.walker2d_v4-s:Walker2dEnv",
    max_episode_steps=1000,
)

register(
    id="HalfCheetahResample-v4",
    entry_point="gymnasium.envs.mujoco.half_cheetah_v4-s:HalfCheetahEnv",
    max_episode_steps=1000,
)
...
register(
    ...
    entry_point="gymnasium.envs.mujoco.hopper_v4-perturbed:HopperEnvPerturbed",
    max_episode_steps=1000,
)

register(
    id="Walker2dPerturbed-v4",
    entry_point="gymnasium.envs.mujoco.walker2d_v4-perturbed:Walker2dEnvPerturbed",
    max_episode_steps=1000,
)

register(
    id="HalfCheetahPerturbed-v4",
    entry_point="gymnasium.envs.mujoco.half_cheetah_v4-perturbed:HalfCheetahEnvPerturbed",
    max_episode_steps=1000,
)
